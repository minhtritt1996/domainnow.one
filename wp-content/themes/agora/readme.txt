== Agora ==
Version: 1.0.0
Copyright: 2024, AncoraThemes 
WordPress version: required at least 5.0, tested up to 6.6.1
...
Please install and activate it before starting to use the theme Agora.
...
Theme documentation is available on https://doc.themerex.net/agora/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Agora is Fontello.
