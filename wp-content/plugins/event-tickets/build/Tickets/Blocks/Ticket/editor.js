...
const RemoveTicketButton = _ref => {
  let {
    onClick,
    isDisabled
  } = _ref;
  return wp.element.createElement(external_tribe_common_elements_["Button"], {
    type: "button",
    onClick: onClick,
    disabled: isDisabled
