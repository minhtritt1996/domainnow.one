...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return setTicketHasChangesInCommonStore; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getTicketIdFromCommonStore; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getTicketProviderFromCommonStore; });
/* harmony import */ var _moderntribe_tickets_data_blocks_ticket_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("hImw");
/* harmony import */ var _moderntribe_tickets_data_blocks_ticket_selectors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("LVGI");
...
function setTicketHasChangesInCommonStore(clientId) {
  dispatchToCommonStore(Object(_moderntribe_tickets_data_blocks_ticket_actions__WEBPACK_IMPORTED_MODULE_0__["setTicketHasChanges"])(clientId, true));
}
...
function getTicketIdFromCommonStore(clientId) {
  return selectFromCommonStore(_moderntribe_tickets_data_blocks_ticket_selectors__WEBPACK_IMPORTED_MODULE_1__["getTicketId"], {
    clientId
  });
}
...
function getTicketProviderFromCommonStore() {
  try {
    return selectFromCommonStore(_moderntribe_tickets_data_blocks_ticket_selectors__WEBPACK_IMPORTED_MODULE_1__["getTicketsProvider"]);
  } catch (e) {
    return '';
  }
}
...
// EXTERNAL MODULE: ./src/Tickets/Commerce/Order_Modifiers/app/blockEditor/store/index.js + 6 modules
var store = __webpack_require__("jJ9e");
...
// EXTERNAL MODULE: ./src/Tickets/Commerce/Order_Modifiers/app/blockEditor/store/common-store-bridge.js
var common_store_bridge = __webpack_require__("1IZQ");

// EXTERNAL MODULE: external "wp.components"
var external_wp_components_ = __webpack_require__("tI+e");

// CONCATENATED MODULE: ./src/Tickets/Commerce/Order_Modifiers/app/blockEditor/fees/add-fee.js
/**
 * External dependencies.
 */
...
const AddFee = _ref => {
  ...
  return wp.element.createElement(external_wp_components_["Button"], {
    ...
    variant: "tertiary",
    onClick: onClick,
    label: Object(external_wp_i18n_["_x"])('Add a fee to the ticket', 'aria-label for adding fee to ticket', 'event-tickets')
  }, Object(external_wp_i18n_["__"])('+ Add fee', 'event-tickets'));
};
/* harmony default export */ var add_fee = (AddFee);
// EXTERNAL MODULE: ./src/modules/elements/index.js + 26 modules
var modules_elements = __webpack_require__("jHzm");

// CONCATENATED MODULE: ./src/Tickets/Commerce/Order_Modifiers/app/blockEditor/fees/map-fee-object.js
/**
 * External dependencies.
 */
...
// CONCATENATED MODULE: ./src/Tickets/Commerce/Order_Modifiers/app/blockEditor/fees/checkbox-fee.js
/**
 * External dependencies.
 */
...
const CheckboxFee = _ref => {
  ...
  return wp.element.createElement("div", {
    className: external_tribe_modules_classnames_default()('tribe-editor__checkbox', getContainerClasses())
  }, wp.element.createElement(external_tribe_common_elements_["CheckboxInput"], {
    checked: isChecked,
...
const CheckboxFeeWithTooltip = _ref2 => {
  ...
  return wp.element.createElement("div", {
    ...
    tooltipLabel: tooltipText && wp.element.createElement(external_wp_components_["Dashicon"], {
...
// CONCATENATED MODULE: ./src/Tickets/Commerce/Order_Modifiers/app/blockEditor/fees/select-fee.js
/**
 * External dependencies.
 */
...
const SelectFee = _ref => {
  ...
  const [selectedFee, setSelectedFee] = Object(external_wp_element_["useState"])('');
  const [addButtonDisabled, setAddButtonDisabled] = Object(external_wp_element_["useState"])(true);
  ...
  return wp.element.createElement("div", {
    className: "tec-events-block-editor__fee-select-container"
  }, wp.element.createElement(external_wp_components_["SelectControl"], {
    className: external_tribe_modules_classnames_default()('tec-events-block-editor__fee-select'),
    hideLabelFromVision: true,
    options: options,
    onChange: onSelectionChange,
    value: selectedFee
  }), wp.element.createElement(external_wp_components_["Button"], {
    className: external_tribe_modules_classnames_default()('tec-events-block-editor__fee-select__add-fee'),
    disabled: addButtonDisabled,
    variant: "secondary",
    label: Object(external_wp_i18n_["_x"])('Confirm adding selected fee to the ticket', 'aria-label for confirming adding selected fee to ticket', 'event-tickets'),
    onClick: () => onConfirm(Number.parseInt(selectedFee))
  }, Object(external_wp_i18n_["__"])('Add fee', 'event-tickets')), wp.element.createElement(external_wp_components_["Button"], {
    className: external_tribe_modules_classnames_default()('tec-events-block-editor__fee-select__cancel'),
    variant: "tertiary",
    label: Object(external_wp_i18n_["_x"])('Cancel adding fee to the ticket', 'aria-label for canceling adding fee to ticket', 'event-tickets'),
    onClick: onCancel
  }, Object(external_wp_i18n_["__"])('Cancel', 'event-tickets')));
};
/* harmony default export */ var select_fee = (SelectFee);
// EXTERNAL MODULE: ./src/Tickets/Commerce/Order_Modifiers/app/blockEditor/fees/style.pcss
var style = __webpack_require__("D69Z");
...
function FeesSection(props) {
  ...
  // Set up the state for the selected fees.
  const [checkedFees, setCheckedFees] = Object(external_wp_element_["useState"])(feeIdSelectedMap);
  ...
  const {
    ...
    removeFeeFromTicket,
    addDisplayedFee
  } = Object(external_wp_data_["useDispatch"])(storeName);
   ...
   */
  const onSelectedFeesChange = Object(external_wp_element_["useCallback"])(event => {
    ...
    setCheckedFees(_objectSpread(_objectSpread({}, checkedFees), {}, {
      [feeId]: isChecked
    }));
    Object(common_store_bridge["c" /* setTicketHasChangesInCommonStore */])(clientId);
  }, [clientId, checkedFees]);

  // Set up the state for the fee selection.
  const [isSelectingFee, setIsSelectingFee] = Object(external_wp_element_["useState"])(false);
  const onAddFeeClick = Object(external_wp_element_["useCallback"])(() => {
    setIsSelectingFee(true);
  }, [clientId]);

  // Set up the functions for the fee selection.
  const onCancelFeeSelect = Object(external_wp_element_["useCallback"])(() => {
    setIsSelectingFee(false);
  }, [clientId]);
  const onConfirmFeeSelect = Object(external_wp_element_["useCallback"])(feeId => {
  ...
  const toolTipText = Object(external_wp_i18n_["__"])('This fee is automatically added to the ticket.', 'event-tickets');
  return wp.element.createElement("div", {
    className: external_tribe_modules_classnames_default()('tribe-editor__ticket__fees', 'tribe-editor__ticket__content-row', 'tribe-editor__ticket__content-row--fees')
  }, wp.element.createElement(external_tribe_common_elements_["LabeledItem"], {
    className: external_tribe_modules_classnames_default()('tribe-editor__labeled-item', 'tribe-editor__ticket__active-fees-label'),
    label: Object(external_wp_i18n_["__"])('Ticket Fees', 'event-tickets')
  }), wp.element.createElement("div", {
    className: "tribe-editor__ticket__order_modifier_fees"
  }, hasAutomaticFees ? feesAutomatic.map(fee => wp.element.createElement(CheckboxFeeWithTooltip, {
    clientId: clientId,
    fee: fee,
    isChecked: true,
    isDisabled: true,
    onChange: () => {},
    tooltipText: toolTipText
  })) : null, hasDisplayedFees ? feesDisplayed.map(fee => wp.element.createElement(CheckboxFee, {
    isDisabled: false,
    onChange: onSelectedFeesChange,
    isChecked: checkedFees[fee.id],
    fee: fee,
    clientId: clientId
  })) : null, isSelectingFee ? wp.element.createElement(select_fee, {
    feesAvailable: selectableFees,
    onCancel: onCancelFeeSelect,
    onConfirm: onConfirmFeeSelect
  }) : wp.element.createElement(add_fee, {
    onClick: onAddFeeClick
  }), !hasItemsToDisplay ? wp.element.createElement("p", null, Object(external_wp_i18n_["__"])('No available fees.', 'event-tickets')) : null));
}
/* harmony default export */ var blockEditor_fees = (FeesSection);
// CONCATENATED MODULE: ./src/Tickets/Commerce/Order_Modifiers/app/blockEditor/store/compatibility.js
 ...
 */
function currentProviderSupportsFees() {
  const provider = Object(common_store_bridge["b" /* getTicketProviderFromCommonStore */])();
  return 'TEC\\Tickets\\Commerce\\Module' === provider;
}
// CONCATENATED MODULE: ./src/Tickets/Commerce/Order_Modifiers/app/blockEditor/hook-callbacks.js
/**
 * External dependencies.
 */
...
const filterSetBodyDetails = (body, clientId) => {
  const feesSelected = Object(external_wp_data_["select"])(store["storeName"]).getSelectedFees(clientId);
 ...
 */
const filterTicketContainerItems = (items, clientId) => {
  ...
  const feeObject = {
    item: wp.element.createElement(blockEditor_fees, {
      clientId: clientId
    }),
    key: 'fees'
  };
 ...
 * @param {object} ticket   The ticket object.
 */
const setFeesForTicket = (clientId, ticket) => {
  ...
  const feesSelected = (fees === null || fees === void 0 ? void 0 : fees.selected_fees) || [];
  Object(external_wp_data_["dispatch"])(store["storeName"]).setTicketFees(clientId, feesSelected);
};
 ...
 * @param {string} clientId The client ID of the ticket block.
 */
const updateFeesForTicket = clientId => {
  Object(external_wp_data_["dispatch"])(store["storeName"]).setFeesByPostId(clientId);
};
// CONCATENATED MODULE: ./src/Tickets/Commerce/Order_Modifiers/app/blockEditor/filters.js
/**
 * External dependencies.
 */
...
Object(external_wp_hooks_["addFilter"])('tec.tickets.blocks.setBodyDetails', namespace, filterSetBodyDetails);

// Add the Fees component to the ticket container.
Object(external_wp_hooks_["addFilter"])('tec.ticket.container.items', namespace, filterTicketContainerItems);

// Set the fees for the ticket.
Object(external_wp_hooks_["addAction"])('tec.tickets.blocks.fetchTicket', namespace, setFeesForTicket);
Object(external_wp_hooks_["addAction"])('tec.tickets.blocks.ticketUpdated', namespace, updateFeesForTicket);
Object(external_wp_hooks_["addAction"])('tec.tickets.blocks.ticketCreated', namespace, updateFeesForTicket);
// CONCATENATED MODULE: ./src/Tickets/Commerce/Order_Modifiers/app/blockEditor/index.js
...
__webpack_require__.d(__webpack_exports__, "storeName", function() { return /* binding */ storeName; });
...
// EXTERNAL MODULE: external "tec.tickets.orderModifiers.rest"
var external_tec_tickets_orderModifiers_rest_ = __webpack_require__("l9iq");

// CONCATENATED MODULE: ./src/Tickets/Commerce/Order_Modifiers/app/blockEditor/store/controls.js
 ...
 */
function fetchFeesFromAPI() {
  return _fetchFeesFromAPI.apply(this, arguments);
}
function _fetchFeesFromAPI() {
  _fetchFeesFromAPI = asyncToGenerator_default()(function* () {
    const url = new URL(`${external_tec_tickets_orderModifiers_rest_["baseUrl"]}/fees`);
    url.searchParams.set('_wpnonce', external_tec_tickets_orderModifiers_rest_["nonce"]);
    ...
    const feesAutomatic = 'object' === typeof (json === null || json === void 0 ? void 0 : json.automatic_fees) ? Object.values(json.automatic_fees) : [];
    const feesAvailable = 'object' === typeof (json === null || json === void 0 ? void 0 : json.selectable_fees) ? Object.values(json.selectable_fees) : [];
...
// CONCATENATED MODULE: ./src/Tickets/Commerce/Order_Modifiers/app/blockEditor/store/actions.js
const actions = {
  /**
   * Set all the fees.
   *
...
const reducer = function () {
  ...
  switch (action.type) {
    ...
    case 'ADD_FEE_TO_TICKET':
      ticketPostId = Object(common_store_bridge["a" /* getTicketIdFromCommonStore */])(clientId);
      ticketFees = state.selectedFeesByClientId[clientId] || [];
      ticketFees.push(action.feeId);
      return reducer_objectSpread(reducer_objectSpread({}, state), {}, {
        selectedFeesByClientId: reducer_objectSpread(reducer_objectSpread({}, state.selectedFeesByClientId), {}, {
          [clientId]: ticketFees
        }),
        selectedFeesByPostId: reducer_objectSpread(reducer_objectSpread({}, state.selectedFeesByPostId), {}, {
    ...
    case 'SET_SELECTED_FEES':
      ticketPostId = Object(common_store_bridge["a" /* getTicketIdFromCommonStore */])(action.clientId);
    ...
    case 'SET_SELECTED_FEES_BY_POST_ID':
      ...
      return reducer_objectSpread(reducer_objectSpread({}, state), {}, {
        selectedFeesByPostId: reducer_objectSpread(reducer_objectSpread({}, selectedFeesByPostId), {}, {
          [ticketPostId]: feesSelected
        })
      });
    case 'SET_DISPLAYED_FEES':
      return reducer_objectSpread(reducer_objectSpread({}, state), {}, {
        displayedFeesByClientId: reducer_objectSpread(reducer_objectSpread({}, state.displayedFeesByClientId), {}, {
...
// CONCATENATED MODULE: ./src/Tickets/Commerce/Order_Modifiers/app/blockEditor/store/selectors.js
...
// CONCATENATED MODULE: ./src/Tickets/Commerce/Order_Modifiers/app/blockEditor/store/index.js
/**
 * External dependencies
 */
...
const resolvers = {
  *getAllFees() {
    const {
      feesAvailable,
      feesAutomatic
    } = yield actions.fetchFeesFromAPI();
    return actions.setAllFees(feesAvailable, feesAutomatic);
  }
};

// @see: https://developer.wordpress.org/block-editor/reference-guides/packages/packages-data/
const store = Object(external_wp_data_["createReduxStore"])(storeName, {
  reducer: reducer,
  actions: actions,
  selectors: selectors,
  controls: controls,
...
module.exports = tec.tickets.orderModifiers.rest;
