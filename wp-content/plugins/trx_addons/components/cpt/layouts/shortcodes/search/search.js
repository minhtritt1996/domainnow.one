	...
	function trx_addons_search_close(search_wrap) {
		...
		if ( search_wrap.hasClass('search_style_fullscreen') ) {
			...
			if ( animation ) {
				...
				search_form_wrap
					.removeClass( animation + ' animated' + ( animation_duration ? ' animated-' + animation_duration : '' ) )
					.addClass( animation_exit ? animation_exit + ' animated' + ( animation_duration ? ' animated-' + animation_duration : '' ) : '' );
				...
				}, animation_duration == 'slow' ? 1000 : ( animation_duration == 'fast' ? 500 : 750 ) );
